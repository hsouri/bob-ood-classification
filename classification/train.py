...
import models
from timm_dataset import create_other_dataset, num_classes
...
def main():
    ...
    ## num_classes
    args.num_classes = num_classes[args.dataset.lower()]
    ...
    if args.dataset != "" and args.dataset.lower() != "imagenet":
        dataset_train = create_other_dataset(
            args.dataset, root=args.data_dir, split=args.train_split, is_training=True,
            class_map=args.class_map,
            download=args.dataset_download,
            batch_size=args.batch_size,
            repeats=args.epoch_repeats)
        dataset_eval = create_other_dataset(
